#!/bin/bash
# =============================================================================
# PBPK Benchmark Comparison: Sounio vs Julia
# =============================================================================
...
echo "=============================================================================="
echo "PBPK Benchmark Comparison: Sounio vs Julia"
echo "=============================================================================="
echo ""
...
# Check Sounio compiler
DEMETRIOS_COMPILER="$PROJECT_ROOT/Darwin-sounio/compiler/target/release/dc"
if [ ! -f "$DEMETRIOS_COMPILER" ]; then
    echo -e "${YELLOW}Building Sounio compiler...${NC}"
    cd "$PROJECT_ROOT/Darwin-sounio/compiler"
...
# -----------------------------------------------------------------------------
# Run Sounio Benchmarks
# -----------------------------------------------------------------------------

echo "=============================================================================="
echo -e "${BLUE}Running Sounio Benchmarks${NC}"
echo "=============================================================================="
echo ""

DEMETRIOS_BENCH="$PROJECT_ROOT/Darwin-sounio/examples/pbpk/pbpk_benchmarks.d"

# Type check first
echo "Type checking Sounio module..."
...
if $DEMETRIOS_COMPILER --help 2>&1 | grep -q "run"; then
    echo "Running Sounio benchmarks with JIT..."
    ...
    echo ""
    echo "Sounio total execution time: ${DEMETRIOS_TIME}ms"
else
    echo "Sounio JIT not available - showing type-check only metrics"
...
echo ""
echo "Files:"
echo "  Sounio: $DEMETRIOS_BENCH"
echo "  Julia:     $JULIA_BENCH"
echo ""
echo "Notes:"
echo "  - Sounio benchmarks require JIT feature for runtime execution"
